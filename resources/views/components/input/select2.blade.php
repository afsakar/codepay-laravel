@props(['data' => [], 'placeholder' => 'Select Option...', 'name' => '', 'emptyMessage' => 'No value match your search.'])
<div
    x-data="select({ data: {{ is_array($options) ? json_encode($options) : json_encode([]) }}, emptyOptionsMessage: '{{ $emptyMessage }}', name: '{{ $name }}', placeholder: '{{ $placeholder }}' })"
    x-init="init()"
                ...
                <span class="inline-block w-full rounded-md shadow-sm">
                      ...
                      >
                            ...
                            <input
                                ...
                                type="search"
                                class="w-full h-full form-control focus:outline-none ring-0 border-0 focus:ring-0"
                            />
