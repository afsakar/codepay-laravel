<div x-data="{ showFilters: false,  openFilters() { this.showFilters = ! this.showFilters } }" class="w-full overflow-x-auto dark:text-gray-400">
    <x-slot name="header">
        {{__('Add/Edit Invoice Items for Invoice #:invoice_number', ['invoice_number' => $invoice->invoice_number])}}
    </x-slot>

    {{-- Header --}}
    <h4 class="flex items-center justify-between my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200" >
        <div class="flex items-center justify-between">
            {{__('Add/Edit Invoice Items')}}
        </div>
        ...
        <div class="flex items-center justify-between">
            ...
            <x-button.link :url="route('invoices')" class="flex items-center justify-between px-3 py-1 m-2 text-sm font-medium leading-5 text-white transition-colors duration-150 border border-transparent rounded-lg focus:outline-none bg-gray-700 active:bg-gray-600 hover:bg-gray-800">
                    ...
                    <div class="text-right space-y-6">
                        ...
                        <table class="border border-gray-700 w-full">
                            <tr class="border-b border-gray-700">
                                <td class="pr-2 border-r border-gray-700">
                                    {{ __('Invoice Type') }}:
                                </td>
                                <td class="px-2">
                                    {{ __('Sale') }}
