<div x-data="{ showFilters: false,  openFilters() { this.showFilters = ! this.showFilters } }" class="w-full overflow-x-auto">
    ...
    <div class="w-full grid gap-4">
        {{-- Filters --}}
        <div class="md:col-start-1 md:col-span-2 sm:w-full" x-show="showFilters">
            <x-card color="bg-cool-gray-200 dark:bg-gray-700">
                <div class="mpr-2 space-y-4">
                    ...
                    <x-input.group inline for="filter-category_id" :label="__('Category')">
                        <x-input.select id="filter-type" wire:model="filters.category_id">
                ...
                <div class="pl-2 space-y-4">
                    ...
                    <x-button wire:click="resetFilters" class="text-white bg-gray-600 dark:bg-gray-400 p-2 rounded-lg">{{ __('Reset Filters') }}</x-button>
                </div>
            </x-card>
        </div>

        <x-card class="sm:w-full md:col-start-3 md:col-end-12">
            {{-- Search Area --}}
